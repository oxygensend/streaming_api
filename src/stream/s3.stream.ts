...
export class S3Stream extends Readable {
    ...
    private _currentCursorPosition = 0; // Holds the current starting position for our range queries
    private _s3DataRange: number = 64 * 1024; // Amount of bytes to grab
    private _s3: S3; // AWS.S3 instance
    private readonly _maxContentLength: number; // Total number of bites in the file
    private readonly _s3StreamParams: S3.GetObjectRequest; // Parameters passed into s3.getObject method
